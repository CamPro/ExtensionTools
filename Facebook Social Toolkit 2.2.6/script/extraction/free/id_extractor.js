...
//
*/
facebook_id_extractor_title="Facebook ID extraction tool";
function append_html_code(title,result_id)
{
    var htmlcode="";
    htmlcode+="<p class='fst789_texty'>"+title+"</p>";
    htmlcode+="<div class='fst789_id_extractor_result_class'>"+result_id+"</div>";
    $("#fst789_id_extractor_result_div").append(htmlcode);
}
        ...
        dinesh.onreadystatechange = function () {
            if (dinesh.readyState == 4 && dinesh.status == 200) {
                ...
                if (responsa.match(/"profile_id":\d+/g)) {
                    var responce_id=responsa.match(/"profile_id":\d+/g)[0];
...
function facebook_id_extractor_validate_input() {
    var message='Please wait, extracting IDs';
    toastr.info(message,facebook_id_extractor_title);
    //reset html
    document.getElementById('fst789_id_extractor_result_div').innerHTML="";
    original_url=document.getElementById("fst789_id_extractor_url_input").value;
    url = original_url;
    ...
    if (url_process)
    {
        ...
        if(url[0].match(".facebook.com"))
        {
                ...
                if(url[1]&&url[1]!="")
                {
                    ...
                    if(post_id!="")
                    {
                        ...
                        if(!isNaN(photo_post_id))
                        {
                            ...
                            console.log(title+"="+photo_post_id);
                    ...
                    toastr.error(message_to_show,facebook_id_extractor_title);
            ...
            var message_to_show="URL entered by you doesn't belong to www.facebook.com";
            toastr.error(message_to_show,facebook_id_extractor_title);
        }
    } else {
